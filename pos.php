        ...
        <div class="row">
            <div class="col-md-12"> 
                <div class="form-group has-feedback"> 
                  ...
                  <input type="text" class="form-control agregaventa" name="busquedaproductov" id="busquedaproductov" name="busquedaproductoc" id="busquedaproductoc" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Realice la Búsqueda por Código, Descripción o Código de Barra">
